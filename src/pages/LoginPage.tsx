  ...
  return (
    <div className="min-h-screen flex bg-white transform scale-90 origin-top">
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden min-h-screen">
        ...
        <div className="absolute top-16 right-16 w-80 h-80 bg-gradient-to-r from-pink-400/30 to-purple-500/30 rounded-full mix-blend-multiply filter blur-3xl animate-float"></div>
        <div className="absolute bottom-24 left-16 w-64 h-64 bg-gradient-to-r from-cyan-400/30 to-pink-400/30 rounded-full mix-blend-multiply filter blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-52 h-52 bg-gradient-to-r from-purple-500/20 to-cyan-500/20 rounded-full mix-blend-multiply filter blur-2xl animate-float" style={{ animationDelay: '4s' }}></div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 gap-2">
                <div className="bg-gradient-to-r from-purple-500 to-purple-600 text-white p-2 rounded-lg">
                  ...
                  <div className="text-sm font-bold">$189,374</div>
                ...
                <div className="bg-white border border-gray-200 p-2 rounded-lg">
                  ...
                  <div className="text-sm font-bold text-gray-900">00:01:30</div>
                  <div className="text-xs text-gray-500">Avg response time</div>
                </div>
                <div className="bg-white border border-gray-200 p-2 rounded-lg">
                  <div className="text-xs text-gray-600">Sales Overview</div>
                  <div className="text-xs font-semibold text-gray-900">Weekly</div>
              ...
              <div className="bg-white border border-gray-200 p-3 rounded-lg">
                <div className="flex justify-between items-center mb-2">
                  <div>
                    ...
                    <div className="text-sm font-bold text-gray-900">$25,684</div>
                  </div>
                ...
                <div className="h-12 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg relative overflow-hidden">
                  ...
                  <svg className="absolute inset-0 w-full h-full" viewBox="0 0 200 48" preserveAspectRatio="none">
                    ...
                    <path
                      d="M10,36 Q50,28 80,32 Q120,24 160,16 Q180,12 190,10"
                    ...
                    />
                    {/* Data points */}
                    <circle cx="10" cy="36" r="1.5" fill="#3B82F6" />
                    <circle cx="80" cy="32" r="1.5" fill="#6366F1" />
                    <circle cx="160" cy="16" r="1.5" fill="#8B5CF6" />
                    <circle cx="190" cy="10" r="1.5" fill="#A855F7" />
                  </svg>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="bg-white border border-gray-200 p-2 rounded-lg">
                  ...
                  <div className="text-xs font-semibold text-gray-900">Sales Categories</div>
